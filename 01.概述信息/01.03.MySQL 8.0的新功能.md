...
本节概述了MySQL 8.0中新增、弃用和删除的内容。附带的一节列出了MySQL 8.0中已添加、已弃用或已删除的MySQL服务器选项和变量；请参阅第1.4节“[MySQL 8.0中引入、弃用或删除的服务器和状态变量和选项](01.04.MySQL 8.0中引入、弃用或删除的服务器和状态变量和选项.md)”。
